...
var validarNombre = function validarNombre(text) {
  if (text == null) {
    return false;
  }
...
var validarEmail = function validarEmail(text) {
  if (text == null) {
    return true;
  }
...
var validarPassword = function validarPassword(text) {
  if (text == null) {
...
var validarNumero = function validarNumero(numero) {
  if (numero == null) {
    return true;
  }
...
var validarUser = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            pool = _context.sent;
            _context.next = 15;
            return pool.request().input("userName", _database.sql.VarChar, user).query(_database.queries.validateUser);
  ...
  return function validarUser(_x) {
