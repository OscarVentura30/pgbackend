...
var loginIn = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var cookies, _req$body, userName, password, _pool, result, comparar, ttoken;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            return _context.abrupt("return", res.status(400).json({
              msg: 'Falta el usuario o clave, datos vacios'
            }));
          ...
          case 9:
            _pool = _context.sent;
            _context.next = 12;
            return _pool.request().input("userName", _database.sql.VarChar, userName).query(_database.queries.loginUser);
          ...
          case 12:
            ...
            return _context.abrupt("return", res.status(404).json({
              msg: 'No existe el usuario o la clave es incorrecta'
            }));

          case 17:
            _context.next = 19;
            return (0, _handleBcrypt.compare)(password, result.recordset[0].password);

          case 19:
            comparar = _context.sent;
            ...
            return _context.abrupt("return", res.json("clave incorrecta"));

          case 25:
            ttoken = jwt.sign({
              id: userName
            }, process.env.TEXTSECRET, {
              expiresIn: 60 * 60 * 24
            });
            /*
  ...
  return function loginIn(_x, _x2) {
